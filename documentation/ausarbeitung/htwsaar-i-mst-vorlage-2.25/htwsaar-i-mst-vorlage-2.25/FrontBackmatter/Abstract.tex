...
\textit{Visual Explainable AI} bietet in der vorliegenden Version Visualisierungen für die XAI-Methoden GRAD-CAM und LIME auf das vortrainierte neuronale Netzwerk EfficientNetV2 an, lässt sich aber aufgrund der implementierten Software-Architektur Model-View-Presenter (MVP) mit Supervising Presenter um weitere Verfahren und Modelle leicht erweitern.
Zur Evaluierung der Wirksamkeit des Tools auf Studierende wurde eine Umfrage durchgeführt, deren Ergebnisse in dieser Ausarbeitung vorgestellt werden.
\todo[]{Hier reviewen.}  
