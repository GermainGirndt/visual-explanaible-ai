...
Obwohl die meisten neutral gegenüber 'Die Erklärungen haben meine Fähigkeit verbessert, KI-Vorhersagen kritisch zu beurteilen.' waren, haben die meisten den Aussagen 'Das Tool hat mir geholfen zu erkennen, wann das Modell möglicherweise falsche Vorhersagen trifft.' und 'Das Tool hat mir geholfen, die Grenzen von KI-Modellen besser zu erkennen.' zugestimmt.

Die Antworten waren neutral zu 'Ich verstehe besser den Unterschied zwischen der Genauigkeit eines Modells und seiner Interpretierbarkeit.'

Die Antworten waren Neutral oder negativ zu 'Ich vertraue der Entscheidung des KI-Modells, nachdem ich das Tool gesehen habe.'
...
GradCam und LIME liefern eine visuelle Erklärung wieso das Modell das Bild einer Klasse zugeordnet hat, es liefert keine Erklärung wieso etwas inkorrekt klassifiziert wurde. 
